function Viewer3D(container) {
    ...
    function rotate(point3D) {
        var x =
            point3D.x * _r[0][0] + point3D.y * _r[0][1] + point3D.z * _r[0][2];
        var y =
            point3D.x * _r[1][0] + point3D.y * _r[1][1] + point3D.z * _r[1][2];
        var z =
            point3D.x * _r[2][0] + point3D.y * _r[2][1] + point3D.z * _r[2][2];
        return { x: x, y: y, z: z };
    }
    ...
    function transformVertices() {
        for (var i = 0; i < _vertices.length; i++) {
            ...
            var xp =
                vertex.x * _r[0][0] + vertex.y * _r[0][1] + vertex.z * _r[0][2];
            var yp =
                vertex.x * _r[1][0] + vertex.y * _r[1][1] + vertex.z * _r[1][2];
            var zp =
                vertex.x * _r[2][0] + vertex.y * _r[2][1] + vertex.z * _r[2][2];
    ...
    function TransparentShader(r, g, b) {
        ...
        this.render = function () {
            ...
            for (var i = 0; i < _faces.length; i++) {
                ...
                var isFrontface =
                    face.transform.centroid.x * face.transform.normal.x +
                        ...
                        (face.transform.centroid.z - _distance) *
                            face.transform.normal.z <
                    0;
            ...
            for (var key in edges) {
                ...
                _canvas.beginPath();
                _canvas.moveTo(
                    _vertices[ids[0]].screenX,
                    _vertices[ids[0]].screenY,
                );
                _canvas.lineTo(
                    _vertices[ids[1]].screenX,
                    _vertices[ids[1]].screenY,
                );
                _canvas.closePath();
                _canvas.stroke();
            }
            ...
            for (var i = 0; i < _lights.length; i++) {
                ...
                r = Math.max(
                    ...
                    Math.min(
                        255,
                        Math.round(
                            applyContrast(r + cos * _lights[i].r, _contrast),
                        ),
                    ),
                );
                g = Math.max(
                    ...
                    Math.min(
                        255,
                        Math.round(
                            applyContrast(g + cos * _lights[i].g, _contrast),
                        ),
                    ),
                );
                b = Math.max(
                    ...
                    Math.min(
                        255,
                        Math.round(
                            applyContrast(b + cos * _lights[i].b, _contrast),
                        ),
                    ),
                );
                //}
